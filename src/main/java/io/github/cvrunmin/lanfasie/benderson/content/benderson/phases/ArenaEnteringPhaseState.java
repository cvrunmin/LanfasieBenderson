    ...
    public boolean tick() {
        ...
        if(!this.owner.level().isClientSide()){
            ...
            if(tick >= 105 && tick <= 120){
                ...
                ((ServerLevel) owner.level()).sendParticles(ParticleTypes.CRIT, owner.getX() + zOffset, owner.getY() + 0.5, owner.getZ(), owner.getArenaRadius() * 2, 0, 0, owner.getArenaRadius(), 0);
