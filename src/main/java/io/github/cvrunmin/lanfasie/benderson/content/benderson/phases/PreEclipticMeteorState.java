...
public class PreEclipticMeteorState implements IPhaseState{
    ...
    public void start() {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            trackingMarkers[i] = new TargetMarker(this.owner.level(), summonPilePoses[i], TargetMarker.MarkerArgs.simple(TargetMarker.MarkerType.GROUND_PROXIMITY, (float) (this.owner.getArenaRadius() * Math.sqrt(2)), 90));
        }
