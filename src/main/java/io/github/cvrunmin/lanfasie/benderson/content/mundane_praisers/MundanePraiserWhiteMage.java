...
public class MundanePraiserWhiteMage extends Mob implements GeoEntity {
    private final AnimatableInstanceCache geoCache = GeckoLibUtil.createInstanceCache(this);
    public MundanePraiserWhiteMage(EntityType<? extends Mob> type, Level level) {
        super(type, level);
    }
    ...
    protected void populateDefaultEquipmentSlots(RandomSource random, DifficultyInstance difficulty) {
        setItemSlot(EquipmentSlot.MAINHAND, AllItems.MUNDANE_PRAISER_CANE.toStack());
    }
