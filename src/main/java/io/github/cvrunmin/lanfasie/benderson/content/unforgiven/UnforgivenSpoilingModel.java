...
public class UnforgivenSpoilingModel extends EntityModel<UnforgivenSpoilingRenderState> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -8.0F, -13.0F, 10.0F, 8.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 22.0F, 5.0F, (float) (-Math.PI * 50 / 180), 0.0F, 0.0F));
        ...
        PartDefinition backlegs = partdefinition.addOrReplaceChild("backlegs", CubeListBuilder.create(), PartPose.offset(0.0F, 23.0F, 6.0F));

		PartDefinition rightBackLeg = backlegs.addOrReplaceChild("right_hind_leg", CubeListBuilder.create(), PartPose.offset(-4.0F, 0.0F, -2.0F));
        ...
        PartDefinition leftBackLeg = backlegs.addOrReplaceChild("left_hind_leg", CubeListBuilder.create(), PartPose.offset(4.0F, 0.0F, -2.0F));
