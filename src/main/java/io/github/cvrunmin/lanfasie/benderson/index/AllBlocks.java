...
public class AllBlocks {
    ...
    public static final DeferredBlock<Block> DEEP_LATENT_BLOCK = BLOCKS.registerBlock("deep_latent_block", prop -> new Block(prop.destroyTime(2).lightLevel(_ -> 2).explosionResistance(20)));
