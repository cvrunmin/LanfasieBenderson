...
public class AllMobEffects {
    ...
    public static final DeferredHolder<MobEffect, CurseVoidHareMobEffect> CURSE_VOID_HARE = MOB_EFFECT.register("curse_void_hare", () -> new CurseVoidHareMobEffect(MobEffectCategory.HARMFUL, 0));
